...
If you want to create a new command (such as *pause* or *say*), add its file in the *commands* folder. In the file, export *errorCheck*, *run*, and *config*. See existing command files for guidance. Your command and all arguments should be lowercase.
